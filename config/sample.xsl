...
<zabbix_export>
    <version>2.0</version>
    <date>2013-03-06T16:34:59Z</date>
    <groups>
        <group>
    ...
    <templates>
        <template>
            <template>ZBX-FORTINET-INTERFACES</template>
            <name>ZBX-FORTINET-INTERFACES</name>
            <groups>
                <group>
                    <name>ZBX-FORTINET-TEMPLATES</name>
                </group>
            ...
            <discovery_rules>
                <discovery_rule>
                    ...
                    <item_prototypes>
                        ...
                        <item_prototype>
                            <name>Associated virtual domain for interface {#SNMPVALUE}</name>
                            <type>10</type>
                            <snmp_community/>
                            <multiplier>0</multiplier>
                            <snmp_oid/>
                        ...
                        <item_prototype>
                            <name>Length of the output packets queue on interface {#SNMPVALUE}</name>
                            <type>4</type>
                            <snmp_community>{$SNMP_COMMUNITY}</snmp_community>
                            <multiplier>0</multiplier>
                        ...
                        <item_prototype>
                            <name>Outgoing discarded packets on interface  $1</name>
                            <type>4</type>
                            <snmp_community>{$SNMP_COMMUNITY}</snmp_community>
                            <multiplier>0</multiplier>
                    ...
                    <trigger_prototypes>
                        ...
                        <trigger_prototype>
                            <expression>{ZBX-FORTINET-INTERFACES:ifAlias[{#SNMPVALUE}].regexp({$INTF_REGEX})}=1&amp;{ZBX-FORTINET-INTERFACES:ifOperStatus[{#SNMPVALUE}].diff(0)}&gt;0</expression>
                        ...
                        <trigger_prototype>
                            <expression>{ZBX-FORTINET-INTERFACES:ifAlias[{#SNMPVALUE}].regexp({$INTF_REGEX})}=0&amp;{ZBX-FORTINET-INTERFACES:ifOperStatus[{#SNMPVALUE}].diff(0)}&gt;0</expression>
                            <name>Operational status was changed on interface {#SNMPVALUE}</name>
                            <url/>
                            <status>0</status>
                            <priority>1</priority>
                        ...
                        <trigger_prototype>
                            <expression>{ZBX-FORTINET-INTERFACES:ifOutQLen[{#SNMPVALUE}].last(0)}&gt;0</expression>
                            <name>Output packets queue for {#SNMPVALUE} is not empty</name>
                            <url/>
                            <status>0</status>
                            <priority>1</priority>
                            <description/>
                    ...
                    <graph_prototypes>
                        <graph_prototype>
                            ...
                            <graph_items>
                                <graph_item>
                                    ...
                                    <type>0</type>
                                    <item>
                                        <host>ZBX-FORTINET-INTERFACES</host>
                                        <key>ifOutErrors[{#SNMPVALUE}]</key>
                                    </item>
                                </graph_item>
                                <graph_item>
                        ...
                        <graph_prototype>
                            <name>Interface {#SNMPVALUE} - Length of the output packets queue</name>
                            <width>900</width>
                            <height>200</height>
                            <yaxismin>0.0000</yaxismin>
                            <yaxismax>100.0000</yaxismax>
